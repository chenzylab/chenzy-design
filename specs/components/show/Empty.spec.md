...
类名约定：`cd-empty`、`cd-empty-image`、`cd-empty-title`、`cd-empty-description`、`cd-empty-action`、`cd-empty-footer`；修饰符 `cd-empty-small/--large`、`cd-empty-horizontal`、`cd-empty-compact`（响应式收缩态）。
