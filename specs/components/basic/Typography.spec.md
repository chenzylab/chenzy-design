...
| gzip 体积（含 ellipsis+copy+edit 全功能） | ≤ 6 KB（core 原语按需 tree-shake，未用功能不打入） |
...
- [ ] editable 含 click/dblclick/icon 触发、maxLength、autosize、键盘提交/取消、焦点归还。
