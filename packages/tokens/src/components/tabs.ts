...
export const tabsTokens = {
  ...
  'tabs-tab-padding': 'var(--cd-spacing-2) var(--cd-spacing-4)',
  'tabs-tab-font-size': 'var(--cd-font-size-2)',
  ...
  'dropdown-radius': 'var(--cd-radius-2)',
  'dropdown-z': 'var(--cd-z-dropdown)',
  'dropdown-min-width': '120px',
  'dropdown-item-padding': 'var(--cd-spacing-2) var(--cd-spacing-3)',
