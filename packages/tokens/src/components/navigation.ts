...
export const navigationTokens = {
  ...
  'breadcrumb-separator-color': 'var(--cd-color-text-3)',
  ...
  'steps-icon-bg': 'var(--cd-color-fill-1)',
  ...
  'steps-icon-color': 'var(--cd-color-text-2)',
  ...
  'steps-line-color': 'var(--cd-color-border)',
