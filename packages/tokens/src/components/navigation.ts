...
export const navigationTokens = {
  ...
  'width-navigation-header-logo': { value: '36px', category: 'width', label: 'Logo 宽度', usage: '导航栏 Logo 图片/图标宽度（对齐 Semi $width-navigation_header_logo）' },
  'height-navigation-header-logo': { value: '36px', category: 'height', label: 'Logo 高度', usage: '导航栏 Logo 图片/图标高度（对齐 Semi $height-navigation_header_logo）' },
  ...
  'spacing-navigation-sub-title-marginbottom': { value: '0', category: 'spacing', label: '子导航标题底外边距', usage: '侧边导航栏子导航标题（.cd-nav-sub-title）底部外边距（对齐 Semi $spacing-navigation_sub_title-marginBottom = 0，独立于普通菜单项的 item-marginbottom）' },
  'spacing-navigation-list-wrapper-paddingtop': { value: '12px', category: 'spacing', label: '列表顶内边距', usage: '导航栏菜单项列表顶部内边距' },
  'spacing-navigation-header-logo-marginleft': { value: '0', category: 'spacing', label: 'Logo 左外边距', usage: '侧边导航栏 Logo 左侧外边距（对齐 Semi $spacing-navigation_header_logo-marginLeft = 0）' },
  'spacing-navigation-header-logo-marginright': { value: '8px', category: 'spacing', label: 'Logo 右外边距', usage: '侧边导航栏 Logo 右侧外边距' },
  'spacing-navigation-header-paddingtop': { value: '32px', category: 'spacing', label: 'header 顶内边距', usage: '侧边导航栏 header 顶部内边距（对齐 Semi $spacing-navigation_header-paddingTop）' },
  'spacing-navigation-header-paddingbottom': { value: '36px', category: 'spacing', label: 'header 底内边距', usage: '侧边导航栏 header 底部内边距（对齐 Semi $spacing-navigation_header-paddingBottom）' },
  'spacing-navigation-horizontal-header-logo-marginright': { value: '24px', category: 'spacing', label: '顶部 header 容器右外边距', usage: '顶部导航栏 header 容器右侧外边距（对齐 Semi $spacing-navigation_horizontal_header_logo-marginRight，作用于 .cd-nav-horizontal .cd-nav-header 容器整体，非 logo 图标自身；Semi variables.scss 里同名 marginLeft 变量未被任何选择器实际引用，属死变量，不迁移）' },
  'spacing-navigation-horizontal-paddingleft': { value: '24px', category: 'spacing', label: '顶部左内边距', usage: '顶部导航栏左侧内边距' },
  'spacing-navigation-horizontal-paddingright': { value: '24px', category: 'spacing', label: '顶部右内边距', usage: '顶部导航栏右侧内边距（对齐 Semi $spacing-navigation_horizontal-paddingRight，与 paddingleft 独立定义）' },
  'spacing-navigation-horizontal-item-not-last-marginright': { value: 'var(--cd-spacing-tight)', category: 'spacing', label: '顶部菜单项右外边距（非末位）', usage: '顶部导航栏菜单项右侧外边距，仅非最后一项生效（对齐 Semi $spacing-navigation_horizontal_nav_list_item_not_last-marginRight）' },
