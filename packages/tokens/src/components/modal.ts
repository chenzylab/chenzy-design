...
export const modalTokens = {
  'modal-radius': 'var(--cd-radius-3)',
  'modal-bg': 'var(--cd-color-bg-0)',
  'modal-shadow': 'var(--cd-shadow-3)',
  'modal-mask-bg': 'rgba(0, 0, 0, 0.45)',
  'modal-padding': 'var(--cd-spacing-6)',
  'modal-header-gap': 'var(--cd-spacing-3)',
  'modal-footer-gap': 'var(--cd-spacing-2)',
  'modal-title-color': 'var(--cd-color-text-0)',
  'modal-title-size': 'var(--cd-font-size-3)',
