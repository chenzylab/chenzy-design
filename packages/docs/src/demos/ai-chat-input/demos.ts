...
export const demos: DemoEntry[] = [
  ...
  entry('06-skills.svelte', '技能与模版', '按 skillHotKey 唤起技能面板，选中插入 skill-slot 节点；hasTemplate 弹模版（含 select-slot 下拉 / input-slot 可编辑填空）。'),
  entry('07-configure.svelte', '配置区', 'renderConfigureArea + Configure 子组件（模型/联网/深度思考/MCP 多选），值发送时进 setup。'),
