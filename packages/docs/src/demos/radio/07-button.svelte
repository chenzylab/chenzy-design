<script lang="ts">
  import { RadioGroup, Radio, Space } from '@chenzy-design/svelte';

  // type='button' 渲染按钮样式单选器，支持 small / middle / large 三种尺寸。
  // 注意：button 类型暂不支持辅助文本（extra）和垂直排列（direction='vertical'）。
</script>
