...
export const demos: DemoEntry[] = [
  ...
  entry('04-shape-size.svelte', '形状与尺寸', 'round/square 两形状 × small/default/large 三尺寸'),
  entry('05-href.svelte', 'href 链接', '有 href 渲染真实 <a>；target=_blank 自动补 rel=noopener noreferrer'),
