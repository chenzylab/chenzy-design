<script lang="ts">
  import { Calendar, RadioGroup, Radio } from '@chenzy-design/svelte';

  // 对齐 Semi「设置周起始日」：weekStartsOn 0=周日 … 6=周六，对月 / 周视图生效。
  let v = $state<0 | 1 | 2 | 3 | 4 | 5 | 6>(0);
</script>
...
<div>
  ...
  <Calendar style="margin-top: 20px;" mode="month" weekStartsOn={v} />
</div>
