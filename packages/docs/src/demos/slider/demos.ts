...
export const demos: DemoEntry[] = [
  ...
  entry('05-tip-formatter.svelte', '自定义提示', 'tipFormatter 自定义气泡文案，返回 null 可隐藏气泡；alwaysShowTip 常驻。'),
  entry('06-marks.svelte', '刻度标签', 'marks 定义刻度，可用对象形式设置单个刻度样式；included=false 时刻度不随选区高亮。'),
  ...
  entry('10-custom-slots.svelte', '自定义渲染', '通过 mark / handle / tooltip 具名 snippet 自定义刻度、手柄与气泡内容。'),
];
