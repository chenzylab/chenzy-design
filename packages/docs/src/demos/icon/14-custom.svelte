<script lang="ts">
  // 自定义图标传入 Icon 组件（严格复刻 Semi：<Icon svg={<CustomIcon />} />）。
  // React 的 svg={<CustomIcon />} 在 Svelte 里映射为 svg={snippet}。
...
{#snippet customIcon()}
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <mask id="mask0" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="1" y="1" width="22" height="22">
