...
<style>
  .demo-header { background: #4f46e5; color: #fff; padding: 12px 24px; }
  .demo-sider { background: #312e81; color: #c7d2fe; padding: 16px 12px; min-width: 120px; }
  .demo-content { background: #f5f3ff; padding: 24px; flex: 1; }
