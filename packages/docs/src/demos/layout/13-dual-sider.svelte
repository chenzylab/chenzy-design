...
<div style="height: 320px; border:1px solid var(--cd-color-border); border-radius:8px; overflow:hidden;">
  <Layout style="height: 100%;">
    ...
    <Layout hasSider>
      <Layout.Sider width={160} style="{cell} background: var(--cd-color-fill-1);">左：导航</Layout.Sider>
      <Layout.Content style="{cell} background: var(--cd-color-bg-0);">中：主内容</Layout.Content>
      <Layout.Sider placement="right" width={160} style="{cell} background: var(--cd-color-fill-1);">右：辅助面板</Layout.Sider>
    </Layout>
