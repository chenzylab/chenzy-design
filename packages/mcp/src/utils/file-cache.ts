/**
 * 文件缓存模块
 * 将缓存存储到用户家目录的 .chenzy-mcp/cache 文件夹中
...
/**
 * 获取缓存根目录
 * Windows: C:\Users\username\.chenzy-mcp\cache
 * macOS: /Users/username/.chenzy-mcp/cache
 * Linux: /home/username/.chenzy-mcp/cache
 */
export function getCacheDir(): string {
  return join(homedir(), '.chenzy-mcp', 'cache');
}
