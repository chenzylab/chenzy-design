...
export const meta = {
  ...
  tokens: [
    ...
    '--cd-sidebar-file-gap',
    '--cd-sidebar-file-menu-gap',
    '--cd-sidebar-file-menu-padding',
    '--cd-sidebar-file-menu-border',
    ...
    // 富文本编辑器正文内容 + 详情编辑区（本轮按 Semi 补的一批）。
