...
export const meta = {
  ...
  props: [
    ...
    { name: 'checkedText', type: 'string', default: 'undefined', desc: 'checked 时显示的文字（checkedChildren 的字符串别名）' },
    { name: 'uncheckedText', type: 'string', default: 'undefined', desc: 'unchecked 时显示的文字' },
    { name: 'checkedContent', type: 'Snippet', default: 'undefined', desc: 'checked 时的 Snippet（checkedChildren 的 Snippet 别名）' },
    { name: 'uncheckedContent', type: 'Snippet', default: 'undefined', desc: 'unchecked 时的 Snippet' },
