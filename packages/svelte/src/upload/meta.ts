...
export const meta = {
  ...
  tokens: ['--cd-color-upload-*', '--cd-width-upload-*', '--cd-height-upload-*', '--cd-spacing-upload-*', '--cd-radius-upload-*', '--cd-font-upload-*', '--cd-height-button-*', '--cd-radius-button', '--cd-spacing-button-default-paddingleft', '--cd-font-button-fontsize', '--cd-focus-ring', '--cd-motion-*', '--cd-color-warning', '--cd-color-danger', '--cd-spacing-*', '--cd-font-size-*', '--cd-border-radius-small'],
} as const;
