...
export const meta = {
  ...
  props: [
    ...
    { name: 'showTooltip', type: "boolean | { type?: 'tooltip'|'popover'; opts?: Record<string, unknown>; renderTooltip?: Snippet<[{ content }]> }", default: 'true', desc: '文件名提示：boolean=原生 title 属性；对象=用 Tooltip/Popover 包裹文件名，renderTooltip 自定义提示内容。对标 Semi showTooltip' },
    ...
    { name: 'renderFileItem', type: 'Snippet<[{ fileItem, remove, retry, preview }]>', default: 'undefined', desc: '完全自定义单个文件项渲染（替换默认列表项，list/text listType）' },
    ...
    { name: 'renderPicPreviewIcon', type: 'Snippet<[{ fileItem, remove, retry, preview }]>', default: 'undefined', desc: '自定义照片墙 hover 预览图标（picture-card），常配合 onPreviewClick。对标 Semi renderPicPreviewIcon' },
    ...
    { name: 'renderFileOperation', type: 'Snippet<[{ fileItem, remove, retry, preview }]>', default: 'undefined', desc: '自定义文件列表项操作区（text/list，替换默认重试/移除）。对标 Semi renderFileOperation' },
    ...
    { name: 'itemStyle', type: 'string | Record<string, string>', default: 'undefined', desc: '每个文件列表项/卡片的自定义 style（合并进容器）。对标 Semi itemStyle' },
