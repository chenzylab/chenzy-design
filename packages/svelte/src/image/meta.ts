...
export const meta = {
  ...
  props: [
    ...
    { name: 'preview', type: 'boolean', default: 'false', desc: '点击图片打开全屏预览' },
    {
      ...
      type: 'string',
      default: 'undefined',
      desc: '预览态展示的独立高清图源（不设则复用 src）',
    },
    { name: 'onError', type: '(e: Event) => void', default: 'undefined', desc: '图片加载失败回调' },
    { name: 'onLoad', type: '(e: Event) => void', default: 'undefined', desc: '图片加载成功回调' },
