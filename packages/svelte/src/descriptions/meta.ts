...
export const meta = {
  ...
  tokens: [
    // Semi descriptions/variables.scss 全量对齐（19）
    ...
    // 组件消费
    '--cd-descriptions-label-color',
    '--cd-descriptions-value-color',
    '--cd-descriptions-value-weight-row',
    '--cd-descriptions-border',
    '--cd-descriptions-label-bg',
    '--cd-descriptions-cell-padding',
    '--cd-descriptions-row-gap',
