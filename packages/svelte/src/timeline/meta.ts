...
export const meta = {
  ...
  tokens: [
    // 对齐 Semi timeline/variables.scss 中组件实际消费的 token
    '--cd-radius-timeline-head',
    // 组件消费
    '--cd-timeline-dot-size',
    '--cd-timeline-dot-color',
    '--cd-timeline-dot-color-success',
    '--cd-timeline-dot-color-warning',
    '--cd-timeline-dot-color-error',
    '--cd-timeline-dot-color-ongoing',
    '--cd-timeline-line-color',
    '--cd-timeline-content-color',
    '--cd-timeline-time-color',
    '--cd-timeline-gap',
