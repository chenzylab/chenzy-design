...
export const meta = {
  ...
  tokens: [
    '--cd-color-badge-default-border-default',
    '--cd-color-badge-default-bg-default',
    '--cd-color-badge-default-text-default',
    '--cd-color-badge-primary-solid-bg-default',
    '--cd-color-badge-primary-light-bg-default',
    '--cd-color-badge-primary-light-text-default',
    '--cd-color-badge-primary-inverted-text-default',
    '--cd-color-badge-secondary-solid-bg-default',
    '--cd-color-badge-secondary-light-bg-default',
    '--cd-color-badge-secondary-light-text-default',
    '--cd-color-badge-secondary-inverted-text-default',
    '--cd-color-badge-tertiary-solid-bg-default',
    '--cd-color-badge-tertiary-light-bg-default',
    '--cd-color-badge-tertiary-light-text-default',
    '--cd-color-badge-tertiary-inverted-text-default',
    '--cd-color-badge-danger-solid-bg-default',
    '--cd-color-badge-danger-light-bg-default',
    '--cd-color-badge-danger-light-text-default',
    '--cd-color-badge-danger-inverted-text-default',
    '--cd-color-badge-warning-solid-bg-default',
    '--cd-color-badge-warning-light-bg-default',
    '--cd-color-badge-warning-light-text-default',
    '--cd-color-badge-warning-inverted-text-default',
    '--cd-color-badge-success-solid-bg-default',
    '--cd-color-badge-success-light-bg-default',
    '--cd-color-badge-success-light-text-default',
    '--cd-color-badge-success-inverted-text-default',
    '--cd-width-badge-dot',
    '--cd-height-badge-dot',
    '--cd-radius-badge-dot',
    '--cd-height-badge-count',
    '--cd-spacing-badge-count-paddingx',
    '--cd-spacing-badge-count-paddingy',
    '--cd-width-badge-border',
    '--cd-z-badge',
  ],
  responsive: false,
  examples: [
