...
export const meta = {
  ...
  props: [
    ...
    { name: 'disableScroll', type: 'boolean', default: 'true', desc: '打开时锁背景滚动；false 等价于 disableScrollLock=true' },
    ...
    { name: 'motion', type: 'boolean', default: 'true', desc: '是否启用动画过渡；false 等价于 motionDisabled=true' },
    ...
    { name: 'afterVisibleChange', type: '(isVisible: boolean) => void', default: 'undefined', desc: '动画结束后（入场或出场）触发，isVisible 为当前可见状态' },
  ],
  events: [
