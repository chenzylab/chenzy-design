...
export const meta = {
  ...
  props: [
    ...
    {
      name: 'pagination',
      type: "false | { pageSize?: number; currentPage?: number; defaultCurrentPage?: number; onPageChange?: (page: number) => void }",
      default: 'undefined',
      desc: 'false 关闭；对象/缺省启用内置分页(pageSize 默认 10)。currentPage 受控不回写',
    },
    {
      name: 'rowSelection',
      type: 'RowSelection<T>',
