...
export const meta = {
  ...
  tokens: [
    // Semi collapse/variables.scss 全量对齐（20）
    ...
    // 组件消费
    '--cd-collapse-header-padding',
    '--cd-collapse-header-color',
    '--cd-collapse-header-weight',
    '--cd-collapse-header-bg-hover',
    '--cd-collapse-header-bg-active',
    '--cd-collapse-content-padding',
    '--cd-collapse-content-color',
    '--cd-collapse-border',
    '--cd-collapse-arrow-color',
    '--cd-collapse-motion-duration',
    '--cd-focus-ring',
    '--cd-spacing-tight',
