...
export const meta = {
  ...
  // Nav token 转引 navigation.ts（Semi navigation/variables.scss 全量对齐）为主 token 源。
  tokens: [
    '--cd-nav-bg',
    '--cd-nav-color',
    '--cd-nav-horizontal-height',
    '--cd-nav-header-height',
    '--cd-nav-header-padding-x',
    '--cd-nav-header-gap',
    '--cd-nav-header-text-size',
    '--cd-nav-header-text-color',
    '--cd-nav-header-text-weight',
    '--cd-nav-footer-padding',
    '--cd-nav-footer-border',
    '--cd-nav-collapse-btn-height',
    '--cd-nav-collapse-btn-radius',
    '--cd-nav-collapse-btn-color',
    '--cd-nav-collapse-btn-hover-bg',
  ],
  aiHints: [
