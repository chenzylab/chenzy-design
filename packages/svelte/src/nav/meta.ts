...
export const meta = {
  ...
  props: [
    ...
    { name: 'tooltipShowDelay', type: 'number', default: '0', desc: '折叠态 tooltip 显示延迟 ms（对齐 Semi DEFAULT_TOOLTIP_SHOW_DELAY）' },
    { name: 'tooltipHideDelay', type: 'number', default: '100', desc: '折叠态 tooltip 隐藏延迟 ms（对齐 Semi DEFAULT_TOOLTIP_HIDE_DELAY）' },
  ...
  subComponents: [
    ...
    },
    {
      ...
      props: [
        ...
        { name: 'tabIndex', type: 'number', default: '0', desc: '外部覆盖 tabIndex（对齐 Semi Item tabIndex）' },
        { name: 'toggleIcon', type: 'Snippet', default: 'undefined', desc: '自定义 toggle 位装饰图标（对齐 Semi Item toggleIcon，非展开语义）' },
        { name: 'tooltipShowDelay', type: 'number', default: 'undefined', desc: '折叠态 tooltip 显示延迟 ms（覆盖 Nav 级，对齐 Semi Item tooltipShowDelay）' },
        { name: 'tooltipHideDelay', type: 'number', default: 'undefined', desc: '折叠态 tooltip 隐藏延迟 ms（覆盖 Nav 级，对齐 Semi Item tooltipHideDelay）' },
    ...
    },
    {
      ...
      props: [
        ...
        { name: 'expandIcon', type: 'Snippet', default: 'undefined', desc: '单项自定义展开箭头（覆盖 Nav 级 expandIcon，对齐 Semi Sub expandIcon）' },
