...
export const meta = {
  ...
  props: [
    ...
    { name: 'showRestTagsPopover', type: 'boolean', default: 'false', desc: '超出 maxTagCount 时，将 +N 悬停展示剩余 tags（title）' },
    { name: 'restTagsPopoverProps', type: 'object', default: 'undefined', desc: '透传给 +N 悬停 popover 的参数（预留）' },
