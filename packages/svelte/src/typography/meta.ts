...
const commonProps = [
  ...
  { name: 'italic', type: 'boolean', default: 'false', desc: '斜体（对齐 Semi）' },
  {
    name: 'ellipsis',
...
export const meta = {
  ...
  subComponents: [
    ...
    { name: 'Typography.Text', element: 'span', props: [...commonProps, { name: 'icon', type: 'Snippet', default: 'undefined', desc: '前置图标（对齐 Semi）' }] },
    { name: 'Typography.Paragraph', element: 'p', props: [...commonProps, { name: 'spacing', type: "'normal'|'extended'", default: "'normal'", desc: '行距（对齐 Semi）' }] },
    {
    ...
    },
    {
      ...
      element: 'span',
      desc: '数值格式化文本（对齐 Semi）：遍历 children 文本节点按规则格式化其中数字。',
      props: [
        ...
        { name: 'type', type: "'default'|'secondary'|'tertiary'|'warning'|'danger'|'success'", default: "'default'", desc: '语义色（同 Text）' },
        { name: 'size', type: "'small'|'default'|'large'", default: "'default'" },
        { name: 'mark', type: 'boolean', default: 'false' },
        { name: 'code', type: 'boolean', default: 'false' },
        { name: 'underline', type: 'boolean', default: 'false' },
      ],
    },
  ],
  ...
  tokens: [
    // —— 文本语义色（Semi $color-typography-*-text）——
    ...
    '--cd-font-typography-paragraph_extended-lineheight',
    ...
    '--cd-spacing-typography-title_h{1..6}-margin',
    '--cd-spacing-typography-title_paragraph-margin',
