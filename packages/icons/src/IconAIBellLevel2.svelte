...
<!-- IconAIBellLevel2 — AI 多彩图标，对齐 Semi IconAIBellLevel2（convertIcon 包 Icon 基座，type='ai_bell_level_2'）。fill 数组自定义多色，size/spin/rotate 由 Icon 基座承载。 -->
<Icon type="ai_bell_level_2" {...rest}>
<svg
            viewBox="0 0 24 24"
            fill="none"
